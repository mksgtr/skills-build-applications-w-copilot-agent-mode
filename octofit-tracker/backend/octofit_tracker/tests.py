...
class ActivityModelTest(TestCase):
    def test_create_activity(self):
        ...
        activity = Activity.objects.create(user=user, activity_type='Running', duration=30, calories_burned=200, date='2026-02-24T10:00:00Z')
...
class WorkoutModelTest(TestCase):
    def test_create_workout(self):
        ...
        workout = Workout.objects.create(user=user, workout_type='Yoga', suggested=True, date='2026-02-24T10:00:00Z')
